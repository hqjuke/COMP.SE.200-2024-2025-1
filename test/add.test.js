...
describe('add', () => {
    ...
    it('should correctly add small decimal numbers', () => {
      expect(add(0.1, 0.2)).to.be.closeTo(0.3, 5);  // 0.1 + 0.2 = 0.3 (with floating point precision tolerance)
      expect(add(0.0001, 0.0002)).to.be.closeTo(0.0003, 5);  // Small decimals
    });
